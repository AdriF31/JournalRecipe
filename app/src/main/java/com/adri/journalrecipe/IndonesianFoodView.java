...
public class IndonesianFoodView extends RecyclerView.Adapter<IndonesianFoodView.viewHolder>{
    ...
    public IndonesianFoodView(ArrayList<String> menuImage, ArrayList<String> menuText,ArrayList<String> infoMakanan, Context context) {
