...
public class KoreanFoodView extends RecyclerView.Adapter<KoreanFoodView.viewHolder>{
    ...
    public KoreanFoodView(ArrayList<String> menuImage, ArrayList<String> menuText,ArrayList<String> infoMakanan, Context context) {
